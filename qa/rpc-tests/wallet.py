...
#   c) node1 mines 32 blocks, so now node 0 has 60001iancoin, node 1 has 4250iancoin, node2 has none.
#   d) node0 sends 601 iancoin to node2, in two transactions (301 iancoin, then 300 iancoin).
