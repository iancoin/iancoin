...
In order to support loading of multiple wallets in iancoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is iancoin.cpp.
...
Changes to iancoin.cpp
----------------------
iancoin.cpp is the entry point into iancoin-qt, and as such, will require some minor modifications to provide hooks for
