Contributing to IanCoin Core
============================

The IanCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the IanCoin Core project, and is not to be
confused with overall IanCoin Network Protocol consensus changes.

Whether a pull request is merged into IanCoin Core rests with the project merge
...
Patches that change IanCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the IanCoin consensus, it must have been
...
The project leader is the release manager for each IanCoin Core release.
