...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "IanCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* IanCoin features */
        {"iancoin", "masternode", &masternode, true, true, false},
        {"iancoin", "listmasternodes", &listmasternodes, true, true, false},
        {"iancoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"iancoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"iancoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"iancoin", "masternodedebug", &masternodedebug, true, true, false},
        {"iancoin", "startmasternode", &startmasternode, true, true, false},
        {"iancoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"iancoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"iancoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"iancoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"iancoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"iancoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"iancoin", "mnsync", &mnsync, true, true, false},
        {"iancoin", "spork", &spork, true, true, false},
        {"iancoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"iancoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use iancoind, or the -server option to iancoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> iancoin-cli " + methodname + " " + args + "\n";
}
