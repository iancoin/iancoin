...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("IanCoin Core iancoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  iancoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded IanCoin transaction") + "\n" +
                               "  iancoin-tx [options] -create [commands]   " + _("Create hex-encoded IanCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded IanCoin transaction
