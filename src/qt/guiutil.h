...
/** Utility functions used by the IanCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render IanCoin addresses in monospace font
...
// Parse "iancoin:" URI into recipient object, return true on successful parsing
