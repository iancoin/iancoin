...
QFontDatabase::addApplicationFont(":/fonts/iancoin_font");

QString windowTitle = tr("IanCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IanCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and IanCoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About IanCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about IanCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IanCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IanCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IanCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a IanCoin: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the IanCoin Core help message to get a list with possible IanCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("IanCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IanCoin network", "", count));
}
...
{
    QString strTitle = tr("IanCoin Core"); // default title
