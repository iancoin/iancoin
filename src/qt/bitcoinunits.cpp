...
// Copyright (c) 2017-2018 The IAN Core developers
...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(IAN);
   // unitlist.append(mIAN);
   // unitlist.append(uIAN);
    return unitlist;
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case IAN:
            return QString("IAN");
        case mIAN:
            return QString("Milli-IAN (1 / 1" THIN_SP_UTF8 "000)");
        case uIAN:
            return QString("Micro-IAN (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case IAN:
            return QString("TestIANs");
        case mIAN:
            return QString("Milli-TestIANs (1 / 1" THIN_SP_UTF8 "000)");
        case uIAN:
            return QString("Micro-TestIANs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
