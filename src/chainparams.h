 ...
 * IanCoin system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& IanCoinDevKey() const { return vIanCoinDevKey; }
    // const std::vector<unsigned char>& IanCoinFundKey() const { return vIanCoinFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vIanCoinDevKey;
    // std::vector<unsigned char> vIanCoinFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
