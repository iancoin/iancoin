...
#if defined(NDEBUG)
#error "IanCoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uiancoin) are considered zero fee (for relaying and mining)
...
int64_t GetMasternodePayment(int nHeight, unsigned mnlevel, int64_t blockValue)
{
    ...
    {
        case 1:
            return blockValue * 0.0118;

        case 2:
            return blockValue * 0.0823;

        case 3:
            return blockValue * 0.6059;
    }
