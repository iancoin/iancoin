/* src/config/iancoin-config.h.  Generated from iancoin-config.h.in by configure.  */
/* src/config/iancoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef IanCoin_CONFIG_H

#define IanCoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.iancoin.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "IanCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "IanCoin Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "iancoin"
