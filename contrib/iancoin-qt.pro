...
RESOURCES += src/qt/iancoin.qrc src/qt/iancoin_locale.qrc

TRANSLATIONS += src/qt/locale/iancoin_bg.ts \
                src/qt/locale/iancoin_de.ts \
                src/qt/locale/iancoin_en.ts \
                src/qt/locale/iancoin_es.ts \
                src/qt/locale/iancoin_fi.ts \
                src/qt/locale/iancoin_fr.ts \
                src/qt/locale/iancoin_it.ts \
                src/qt/locale/iancoin_ja.ts \
                src/qt/locale/iancoin_pl.ts \
                src/qt/locale/iancoin_pt.ts \
                src/qt/locale/iancoin_ru.ts \
                src/qt/locale/iancoin_sk.ts \
                src/qt/locale/iancoin_sv.ts \
                src/qt/locale/iancoin_vi.ts \
                src/qt/locale/iancoin_zh_CN.ts \
                src/qt/locale/iancoin_zh_TW.ts
